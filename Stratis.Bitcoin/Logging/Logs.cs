...
namespace Stratis.Bitcoin.Logging {
   public class Logs {
      ...
      public static ILogger Configuration { get; set; }
      public static ILogger RPC { get; set; }
      public static ILogger FullNode { get; set; }
      public static ILogger ConnectionManager { get; set; }
      public static ILogger Bench { get; set; }
      public static ILogger Mempool { get; set; }
      public static ILogger BlockStore { get; set; }
      public static ILogger EstimateFee { get; set; }
